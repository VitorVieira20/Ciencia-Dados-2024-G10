...
class ModelD:
    def __init__(self, data_train, labels_train, data_test, labels_test):
        ...
        self.model = keras.Sequential([
            layers.Dense(64, activation='relu', input_shape=[self.data_train.shape[1]]),
    ...
    def train_and_evaluate(self):
        ...
        history = self.model.fit(self.X_train_normalized, self.labels_train, epochs=10, batch_size=32, validation_split=0.2)
